...
class Site implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'groupName' => 'string',
        'tags' => 'string[]',
        'installs' => '\WPEngineGenerated\Model\SiteInstallsInner[]'
    ];
    ...
    */
     ...
     * Gets installs
     *
     * @return \WPEngineGenerated\Model\SiteInstallsInner[]|null
     */
     ...
     * Sets installs
     *
     * @param \WPEngineGenerated\Model\SiteInstallsInner[]|null $installs installs
     *
     * @return self
     */
    ...
    {
        if (is_null($installs)) {
            throw new \InvalidArgumentException('non-nullable installs cannot be null');
        }
