...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.wpengineapi.com/v1';
    ...
    {
        $report  = 'PHP SDK (WPEngineGenerated) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.6.7' . PHP_EOL;
