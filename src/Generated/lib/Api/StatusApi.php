...
/**
     ...
     * @return \WPEngineGenerated\Model\Status
     */
    public function status(string $contentType = self::contentTypes['status'][0])
    {
        list($response) = $this->statusWithHttpInfo($contentType);
        return $response;
    }
     ...
     * @throws \WPEngineGenerated\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \WPEngineGenerated\Model\Status, HTTP status code, HTTP response headers (array of strings)
     */
    public function statusWithHttpInfo(string $contentType = self::contentTypes['status'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\WPEngineGenerated\Model\Status' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\WPEngineGenerated\Model\Status' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\WPEngineGenerated\Model\Status', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\WPEngineGenerated\Model\Status';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WPEngineGenerated\Model\Status',
